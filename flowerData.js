...
var vase = {
 flowers: [
   ...
   },
   {
     ...
     isEdible: true,
     smellsPretty: true,
     comments: "Rose perfumes are made from attar of roses or rose oil, which is a mixture of volatile essential oils obtained by steam distilling the crushed petals of roses. "
   }
 ]
}
